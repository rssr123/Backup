...
@Component({
  selector: 'app-court-order-details',
  templateUrl: './court-order-details.component.html',
  styleUrls: ['./court-order-details.component.scss']
})
export class CourtOrderDetailsComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.taskNo = history.state.task_no;//
