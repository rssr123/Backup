...
@Component({
  selector: 'app-refund-created-task-rf-details',
  templateUrl: './refund-created-task-rf-details.component.html',
  styleUrls: ['./refund-created-task-rf-details.component.scss']
})
export class RefundCreatedTaskRfDetailsComponent {
    ...
    this.http.post(url, requestBody, { headers }).subscribe(
      (response: any) => {
        if (Array.isArray(response)) {
          ...
          this.alertMessage = 'Unexpected response format while fetching documents.';
