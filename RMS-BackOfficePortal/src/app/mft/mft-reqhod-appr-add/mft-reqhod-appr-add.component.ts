...
@Component({
  selector: 'app-mft-reqhod-appr-add',
  templateUrl: './mft-reqhod-appr-add.component.html',
  styleUrls: ['./mft-reqhod-appr-add.component.scss'],
  animations: [fadeInOut]
})
export class MftReqhodApprAddComponent implements OnInit {
  ...
  permApproveAddMFTRequesterFormRHOD = perm.Master_Fee_Table_Approve_Add_MFT_Requester_Form_RHOD; // all the perm_cd for this module seperated with comma
  permApproveAddMFTRequesterFormRHODAllow = ""; // variable to store allowed permission for the user
  ...
  checkPermission() {
    this.authService.checkUserRole(this.authService.username, this.permApproveAddMFTRequesterFormRHOD)
      .subscribe(
        (response: any) => {
          this.permApproveAddMFTRequesterFormRHODAllow = response.data;
          console.log("this.permApproveAddMFTRequesterFormRHODAllow " + this.permApproveAddMFTRequesterFormRHODAllow);
          this.permListAllow = this.permApproveAddMFTRequesterFormRHODAllow.includes(perm.Master_Fee_Table_Approve_Add_MFT_Requester_Form_RHOD) ? 1 : 0;
