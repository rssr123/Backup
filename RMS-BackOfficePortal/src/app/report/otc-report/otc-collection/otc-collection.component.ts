...
@Component({
  selector: 'app-otc-collection',
  templateUrl: './otc-collection.component.html',
  styleUrls: ['./otc-collection.component.scss']
})
export class OtcCollectionComponent {
  dlUrl = environment.apiUrl + '/api/otcreport/v1/otccollection';
  ...
  dateRange: Date[] | null = null;
	...
	permList = perm.Reporting_and_Analysis_OTC_Collection
  permListResponse = "";
  ...
  authorization() {
    ...
    .subscribe(
      (response: any) => {
        ...
        this.permViewAllow = this.permListResponse.includes(perm.Reporting_and_Analysis_OTC_Collection) ? 1 : 0;
