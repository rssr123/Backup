...
@Component({
  selector: 'app-daily-balancing',
  templateUrl: './daily-balancing.component.html',
  styleUrls: ['./daily-balancing.component.scss']
})
export class DailyBalancingComponent implements OnInit {
  dlUrl = environment.apiUrl + '/api/otcreport/v1/dailybalancing';
  ...
  permList = perm.Reporting_and_Analysis_Daily_Balancing
  permListResponse = "";
  ...
  authorization() {
    ...
    .subscribe(
      (response: any) => {
        ...
        this.permViewAllow = this.permListResponse.includes(perm.Reporting_and_Analysis_Daily_Balancing) ? 1 : 0;
