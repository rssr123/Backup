...
@Component({
  selector: 'app-otc-receipt-cancellation',
  templateUrl: './otc-receipt-cancellation.component.html',
  styleUrls: ['./otc-receipt-cancellation.component.scss']
})
export class OtcReceiptCancellationComponent {
  dlUrl = environment.apiUrl + '/api/otcreport/v1/otcreceiptcancellation';
  ...
  permList = perm.Reporting_and_Analysis_OTC_Receipt_Cancellation
  permListResponse = "";
  ...
  authorization() {
    ...
    .subscribe(
      (response: any) => {
        ...
        this.permViewAllow = this.permListResponse.includes(perm.Reporting_and_Analysis_OTC_Receipt_Cancellation) ? 1 : 0;
