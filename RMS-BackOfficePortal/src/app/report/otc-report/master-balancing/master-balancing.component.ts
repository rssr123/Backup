...
@Component({
  selector: 'app-master-balancing',
  templateUrl: './master-balancing.component.html',
  styleUrls: ['./master-balancing.component.scss']
})
export class MasterBalancingComponent {
  dlUrl = environment.apiUrl + '/api/otcreport/v1/masterbalancing';
  ...
  permList = perm.Reporting_and_Analysis_Master_Balancing
  permListResponse = "";
  ...
  authorization() {
    ...
    .subscribe(
      (response: any) => {
        ...
        this.permViewAllow = this.permListResponse.includes(perm.Reporting_and_Analysis_Master_Balancing) ? 1 : 0;
