...
import { FeeDetailList } from 'src/app/core/models/fee-detail-list.interface';

@Component({
  selector: 'app-otc-collection-plus',
  templateUrl: './otc-collection-plus.component.html',
  styleUrls: ['./otc-collection-plus.component.scss']
})
export class OtcCollectionPlusComponent {
  dlUrl = environment.apiUrl + '/api/otcreport/v1/otccollectionplus';
  ...
  ledgerCode: String | null = null;

	showResultAlert = false;

  permList = perm.Reporting_and_Analysis_OTC_Collection_By_Fee_Detail_ID
  permListResponse = "";
  ...
  authorization() {
    ...
    .subscribe(
      (response: any) => {
        ...
        this.permViewAllow = this.permListResponse.includes(perm.Reporting_and_Analysis_OTC_Collection_By_Fee_Detail_ID) ? 1 : 0;
  ...
  loadFeeDetails() {
    ...
    const url2 = environment.apiUrl + '/api/helper/v1/getfeedetaillist';
