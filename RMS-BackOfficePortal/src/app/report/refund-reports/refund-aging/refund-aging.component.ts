...
@Component({
  selector: 'app-refund-aging',
  templateUrl: './refund-aging.component.html',
  styleUrls: ['./refund-aging.component.scss']
})
export class RefundAgingComponent implements OnInit {

  dlUrl = environment.apiUrl + '/api/rs/v1/refundAging';
  ...
  refundStatuses = [
    ...
    { value: 'PRG', label: 'Pending Refund Slip Generated' },
    { value: 'T1', label: 'Pending FSM/FHOD' },
    { value: 'T2', label: 'Pending DCEO' },
    { value: 'T3', label: 'Pending CEO' },
    { value: 'REG', label: 'Refund Email Slip Generated' },
    { value: 'RBIS', label: 'Refund Bank Info Submitted' },
    { value: 'PRS', label: 'Pending Refund Submitted' },
    { value: 'PERS', label: 'Pending Email Refund Submitted' }
  ];
  ...
  refundTypes = [
    ...
    { value: 'RF', label: 'Refund Form' }
  ];

      // Configuring Permissions for User and roles variables
      permList = perm.Reporting_and_Analysis_Refund_Aging 
      permListResponse = "";
      ...
      authorization() {
        ...
        .subscribe(
          (response: any) => {
            ...
            this.permViewAllow = this.permListResponse.includes(perm.Reporting_and_Analysis_Refund_Aging) ? 1 : 0;
  ...
  // validateRefundDateRange(): boolean {
