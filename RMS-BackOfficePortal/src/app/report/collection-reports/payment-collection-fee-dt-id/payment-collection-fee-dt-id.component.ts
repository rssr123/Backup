...
@Component({
	selector: 'app-payment-collection-fee-dt-id',
  templateUrl: './payment-collection-fee-dt-id.component.html',
  styleUrls: ['./payment-collection-fee-dt-id.component.scss']
})
export class PaymentCollectionFeeDtIdComponent implements OnInit {
	...
	groupType: string = 'pymt_col_fee_dt_id';
	...
	resetWithDefaults() {
		...
		this.start_month = 1;
		this.groupType = 'pymt_col_fee_dt_id';
		this.date_range = [new Date((new Date()).getFullYear() + '-01-01'), new Date()];
		this.pymt_Mthd = ['CC'];
	}
	...
	dlbuttonPerms() {
		if (this.isLoading || this.selectedFileType.length < 1 || (this.groupType === null) || (this.start_month === null) || (this.end_month === null) || (this.pymt_Mthd === null) || (this.search_year === null) || (this.search_year < 999) || (this.pymt_Mthd.length === 0) || (this.date_range.length === 0)
