...
@Component({
	selector: 'app-payment-collection-pymt-md',
  templateUrl: './payment-collection-pymt-md.component.html',
  styleUrls: ['./payment-collection-pymt-md.component.scss']
})
export class PaymentCollectionPymtMdComponent implements OnInit {
	...
	groupType: string = 'pymt_col_pymt_md';
