...
export class PaymentCollectionComponent implements OnInit {
	...
	dlbuttonPermsXlsx(){
		if (this.isLoading || (this.groupType === null) || (this.start_month === null) || (this.end_month === null) || (this.pymt_Mthd === null) || (this.search_year === null) || (this.search_year < 999) || (this.pymt_Mthd.length === 0) || (this.date_range.length === 0)
	...
	dlbuttonPermsCsv(){
		if (this.isLoading || (this.groupType === null) || (this.start_month === null) || (this.end_month === null) || (this.pymt_Mthd === null) || (this.search_year === null) || (this.search_year < 999) || (this.pymt_Mthd.length === 0) || (this.date_range.length === 0)
			|| (this.groupType === 'pymt_col_pymt_md' && this.permDownloadCSVPaymentModeAllow === 0) 
			|| (this.groupType === 'pymt_col_s_s' && this.permDownloadCSVSourceSystemAllow === 0) 
			|| (this.groupType === 'pymt_col_fee_dt_id' && this.permDownloadCSVFeeDetailIDAllow === 0))
				return true;
		return false;
	}
	...
	dlbuttonPermsPdf(){
		if (this.isLoading || (this.groupType === null) || (this.start_month === null) || (this.end_month === null) || (this.pymt_Mthd === null) || (this.search_year === null) || (this.search_year < 999) || (this.pymt_Mthd.length === 0) || (this.date_range.length === 0)
			|| (this.groupType === 'pymt_col_pymt_md' && this.permDownloadPDFPaymentModeAllow === 0) 
			|| (this.groupType === 'pymt_col_s_s' && this.permDownloadPDFSourceSystemAllow === 0) 
			|| (this.groupType === 'pymt_col_fee_dt_id' && this.permDownloadPDFFeeDetailIDAllow === 0))
				return true;
		return false;
	}
			...
			.subscribe(
		        ...
		        (error: any) => {
		        	console.log("access-denied");					
		          	this.permViewPaymentModeAllow = 0;
					this.permDownloadPDFPaymentModeAllow = 0;
					this.permDownloadExcelPaymentModeAllow = 0;
					this.permDownloadCSVPaymentModeAllow = 0;
					this.permViewSourceSystemAllow = 0;
					this.permDownloadPDFSourceSystemAllow = 0;
					this.permDownloadExcelSourceSystemAllow = 0;
					this.permDownloadCSVSourceSystemAllow = 0;
					this.permViewFeeDetailIDAllow = 0;
					this.permDownloadPDFFeeDetailIDAllow = 0;
					this.permDownloadExcelFeeDetailIDAllow = 0;
					this.permDownloadCSVFeeDetailIDAllow = 0;
		        }
			);
	}
