...
@Service
@Slf4j
public class DetailedBilBillingTypeReportGenerator {
    private final String report = "/jasper/Detailed_Billing_BillingType_Report.jrxml";
	private String report_directory;

	@Autowired
	private DataSource ds;

    public DetailedBilBillingTypeReportGenerator(@Value("${jasper.reports.directory}") String report_directory) {
        this.report_directory = report_directory;
        log.info("Starting DetailedBilBillingTypeReportGenerator...");
    }
