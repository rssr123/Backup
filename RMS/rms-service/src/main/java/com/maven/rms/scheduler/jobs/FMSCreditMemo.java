...
@Component
@Slf4j
public class FMSCreditMemo implements Job {
    //private static final Logger logger = LoggerFactory.getLogger(FMSCreditMemo.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        schedulerUpdRequest.setI_function_nm("FMSCreditMemo");
        if(schService.sp_getjobstatus(schedulerUpdRequest).equals("E")){
            log.info("FMSCreditMemo job has error. Exiting...");
            return;
        }
        
        RMSLogger.schedulerInfo("FMSCRMemo is Initializing...");
        //set variables
        int result = 0;

        SchedulerLog newLog = new SchedulerLog("FMSCreditMemo.",
        ...
        try {
            ...
            schedulerUpdRequestSucc.setI_function_nm("FMSCreditMemo");
            ...
            schedulerUpdRequestErr.setI_function_nm("FMSCreditMemo");
