...
@Service
@Slf4j
public class OTCReceiptCancellationReportGenerator {
    private final String report = "/jasper/OTC_Receipt_Cancellation.jrxml";
	...
	public OTCReceiptCancellationReportGenerator(@Value("${jasper.reports.directory}") String report_directory){
		this.report_directory = report_directory;
		log.info("Starting OTCReceiptCancellationReportGenerator...");
	}
