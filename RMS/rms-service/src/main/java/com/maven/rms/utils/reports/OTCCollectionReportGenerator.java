...
@Service
@Slf4j
public class OTCCollectionReportGenerator {
    private final String report = "/jasper/OTC_Collection.jrxml";
	...
	public OTCCollectionReportGenerator(@Value("${jasper.reports.directory}") String report_directory){
		this.report_directory = report_directory;
		log.info("Starting OTCCollectionReportGenerator...");
	}
