...
@Service
@Slf4j
public class SummaryBillingReportGenerator {
    private final String report = "/jasper/Summary_Billing_Report.jrxml";
	private String report_directory;

	@Autowired
	private DataSource ds;

    public SummaryBillingReportGenerator(@Value("${jasper.reports.directory}") String report_directory) {
        this.report_directory = report_directory;
        log.info("Starting SummaryBillingReportGenerator...");
    }

    public File generateReport(SummaryBillingReportRequest r) throws IOException, JRException, SQLException {
    ...
    private Map<String, Object> reportParameters(SummaryBillingReportRequest request) {
        ...
        parameters.put("billingstatus", request.getBillingStatus());
        return parameters;
    }
}
