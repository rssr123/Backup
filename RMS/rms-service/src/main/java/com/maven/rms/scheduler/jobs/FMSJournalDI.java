...
@Component
@Slf4j
public class FMSJournalDI implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        schedulerUpdRequest.setI_function_nm("FMSJournalDI");
        if(schService.sp_getjobstatus(schedulerUpdRequest).equals("E")){
            log.info("FMSJournalDI job has error. Exiting...");
            return;
        }
        int succUpdates = 0;
        int failUpdates = 0;
        ...
        try {
            SchedulerLog newLog = new SchedulerLog("Process FMSJournalDI.",
            ...
            schedulerUpdRequestSucc.setI_function_nm("FMSJournalDI");
            ...
            schedulerUpdRequestErr.setI_function_nm("FMSJournalDI");
