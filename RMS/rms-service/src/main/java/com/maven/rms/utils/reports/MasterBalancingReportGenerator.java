...
@Service
@Slf4j
public class MasterBalancingReportGenerator {
    private final String report = "/jasper/Master_Balancing.jrxml";
	...
	public MasterBalancingReportGenerator(@Value("${jasper.reports.directory}") String report_directory){
		this.report_directory = report_directory;
		log.info("Starting MasterBalancingReportGenerator...");
	}
