...
public class SubmitRefundResponseFail {
    ...
    public static class Data {
        ...
        private String app_rejected_reason; // Add this field
        ...
        public String getApp_rejected_reason() {
            return app_rejected_reason;
        }

        public void setApp_rejected_reason(String app_rejected_reason) {
            this.app_rejected_reason = app_rejected_reason;
        }
    }
