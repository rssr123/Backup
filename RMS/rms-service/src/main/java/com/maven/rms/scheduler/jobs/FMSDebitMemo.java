...
@Component
@Slf4j
public class FMSDebitMemo implements Job {
    //private static final Logger logger = LoggerFactory.getLogger(FMSDebitMemo.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        schedulerUpdRequest.setI_function_nm("FMSDebitMemo");
        if(schService.sp_getjobstatus(schedulerUpdRequest).equals("E")){
            log.info("FMSDebitMemo job has error. Exiting...");
            return;
        }
        RMSLogger.schedulerInfo("FMSDRMemo is Initializing...");
        //set variables
        int result = 0;

        SchedulerLog newLog = new SchedulerLog("FMSDebitMemo.",
        ...
        try {
            ...
            schedulerUpdRequestSucc.setI_function_nm("FMSDebitMemo");
            ...
            schedulerUpdRequestErr.setI_function_nm("FMSDebitMemo");
