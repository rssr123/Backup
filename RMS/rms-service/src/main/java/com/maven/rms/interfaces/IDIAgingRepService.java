...
public interface IDIAgingRepService {
    ...
    List<DeferredIncomeAging> sp_getdiaginglistingrpt(DeferredIncomeAgingRequest DIRequest);

    Integer sp_upddiagingrpt(DeferredIncomeAgingRequest DIRequest, String i_modified_by);

    List<DeferredIncomeAging> sp_getdiagingrpt(BigInteger i_rpt_di_age_id);

    Integer sp_getdiagequeuerpt();

    List<DeferredIncomeAging> sp_getpendingdiagingrpt();
