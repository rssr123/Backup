...
@Component
@Slf4j
public class FMSJournalRICP implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        schedulerUpdRequest.setI_function_nm("FMSJournalRICP");
        if(schService.sp_getjobstatus(schedulerUpdRequest).equals("E")){
            log.info("FMSJournalRICP job has error. Exiting...");
            return;
        }
        int succUpdates = 0;

        try {
            SchedulerLog newLog = new SchedulerLog("Process FMSJournalRICP.",
            ...
            schedulerUpdRequestSucc.setI_function_nm("FMSJournalRICP");
            ...
            schedulerUpdRequestErr.setI_function_nm("FMSJournalRICP");
