...
@Service
@Slf4j
public class DailyBalancingReportGenerator {
    private final String report = "/jasper/Daily_Balancing.jrxml";
	...
	public DailyBalancingReportGenerator(@Value("${jasper.reports.directory}") String report_directory){
		this.report_directory = report_directory;
		log.info("Starting DailyBalancingReportGenerator...");
	}
