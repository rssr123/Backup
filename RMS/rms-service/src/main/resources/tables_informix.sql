...
CREATE TABLE IF NOT EXISTS qblob_triggers (
...
CREATE TABLE IF NOT EXISTS qcalendars (
SCHED_NAME VARCHAR(120) NOT NULL,
...
CREATE TABLE IF NOT EXISTS qcron_triggers (
SCHED_NAME VARCHAR(120) NOT NULL,
TRIGGER_NAME varchar(80) NOT NULL,
TRIGGER_GROUP varchar(80) NOT NULL,
...
CREATE TABLE IF NOT EXISTS qfired_triggers (
SCHED_NAME VARCHAR(120) NOT NULL,
...
CREATE TABLE IF NOT EXISTS qpaused_trigger_grps (
SCHED_NAME VARCHAR(120) NOT NULL,
TRIGGER_GROUP  varchar(80) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS qscheduler_state (
SCHED_NAME VARCHAR(120) NOT NULL,
INSTANCE_NAME varchar(80) NOT NULL,
...
CREATE TABLE IF NOT EXISTS qlocks (
SCHED_NAME VARCHAR(120) NOT NULL,
...
CREATE TABLE IF NOT EXISTS qjob_details (
SCHED_NAME VARCHAR(120) NOT NULL,
...
CREATE TABLE IF NOT EXISTS qsimple_triggers (
SCHED_NAME VARCHAR(120) NOT NULL,
TRIGGER_NAME varchar(80) NOT NULL,
TRIGGER_GROUP varchar(80) NOT NULL,
...
CREATE TABLE IF NOT EXISTS qsimprop_triggers
  (          
    SCHED_NAME VARCHAR(120) NOT NULL,
    TRIGGER_NAME VARCHAR(80) NOT NULL,
    TRIGGER_GROUP VARCHAR(80) NOT NULL,
...
CREATE TABLE IF NOT EXISTS qtriggers (
SCHED_NAME VARCHAR(120) NOT NULL,
TRIGGER_NAME varchar(80) NOT NULL,
TRIGGER_GROUP varchar(80) NOT NULL,
JOB_NAME varchar(80) NOT NULL,
